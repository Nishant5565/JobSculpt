  ...
  >
    <div className="container flex flex-col gap-10 h-screen items-center justify-center py-4 px-6">
      ...
      <div className="gap-10 flex flex-col items-center justify-center">
        <Link to="/" className="relative group hover:text-aesthetic-blue">
          Hire
        </Link>
        <Link to="/about" className="relative group hover:text-aesthetic-blue">
          About
        </Link>
        <Link
          to="/FindJobs"
        ...
        <Link to="/contact" className="relative group hover:text-aesthetic-blue">
          Contact
        </Link>
      </div>
